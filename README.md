...
Методы решения не были вынесены в отдельные классы, так как условие ЛР по ЛАВМ предполагает использование только 3-х методов, а для 3-х методов это было бы бесполезно (расширяемости нет)
